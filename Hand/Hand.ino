...
void setup() {
  ...
  myServo1.attach(15); //A1 //thumb
  myServo2.attach(16); //A2 // litlle 
  myServo3.attach(17); //A3 //behind the thumb 
  //myServo4.attach(18); //A4 //middle
  //myServo5.attach(19); //A5 //between midlle and small 
